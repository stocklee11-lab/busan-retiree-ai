...
if menu == "16개 구·군 광역 분석":
    ...
    gu_database = {
        "부산진구": {
            "단지명": ["개금동 반도보라", "전포동 대동파크", "부암동 화승삼성", "가야동 가야벽산", "양정동 현대아파트", "당감동 백양순환"],
        ...
        "해운대구": {
            "단지명": ["좌동 해운대대림", "우동 삼호가든", "재송동 더샵센텀파크", "좌동 화목데파트", "반여동 아시아선수촌", "우동 해운대자이"],
        ...
        "사하구": {
            "단지명": ["하단동 가락타운", "신평동 삼익아파트", "괴정동 한신아파트", "다대동 몰운대아파트", "당리동 동원베네스트"],
        ...
        "수영구": {
            "단지명": ["남천동 삼익비치", "광안동 쌍용예가", "민락동 센텀비치푸르지오", "망미동 수영강변e편한"],
            "법정동": ["남천동", "광안동", "민락동", "망미동"],
        ...
        "금정구": {
            "단지명": ["장전동 래미안장전", "구서동 롯데캐슬", "남산동 럭키아파트", "구서동 쌍용예가"],
            "법정동": ["장전동", "구서동", "남산동", "구서동"],
        ...
        "남구": {
            "단지명": ["대연동 힐스테이트푸르지오", "용호동 오륙도SK뷰", "문현동 한화꿈에그린", "감만동 현대아파트"],
            "법정동": ["대연동", "용호동", "문현동", "감만동"],
        ...
        "동래구": {
            "단지명": ["명륜동 명륜자이", "온천동 래미안포레스티지", "사직동 사직자이", "안락동 강변타운"],
            "법정동": ["명륜동", "온천동", "사직동", "안락동"],
        ...
        "북구": {
            "단지명": ["화명동 코오롱하늘채", "덕천동 주공아파트", "만덕동 동문굿모닝힐", "금곡동 화명리버빌"],
            "법정동": ["화명동", "덕천동", "만덕동", "금곡동"],
        ...
        "연제구": {
            "단지명": ["거제동 롯데캐슬피렌체", "연산동 더샵파크시티", "연산동 자이아파트"],
            "법정동": ["거제동", "연산동", "연산동"],
            "매매가_억": [5.8, 4.6, 4.9],
        ...
        "사상구": {
            "단지명": ["엄궁동 롯데캐슬", "주례동 한일유앤아이", "감전동 동부아파트", "괘법동 한신아파트"],
            "법정동": ["엄궁동", "주례동", "감전동", "괘법동"],
        ...
        "강서구": {
            "단지명": ["명지동 더샵퍼스트월드", "명지동 호반베르디움", "지사동 삼정그린코아"],
            "법정동": ["명지동", "명지동", "지사동"],
            "매매가_억": [5.1, 4.2, 1.8],
        ...
        "기장군": {
            "단지명": ["정관동 이진캐스빌", "기장읍 동원로얄듀크", "일광동 e편한세상일광"],
            "법정동": ["정관읍", "기장읍", "일광읍"],
            "매매가_억": [2.7, 2.4, 3.8],
        ...
        "서구": {
            "단지명": ["암남동 송도비치힐", "동대신동 삼익아파트", "서대신동 푸르지오"],
            "법정동": ["암남동", "동대신동", "서대신동"],
            "매매가_억": [2.5, 2.8, 4.5],
        ...
        "동구": {
            "단지명": ["초량동 e편한세상북항", "수정동 협성휴포레", "좌천동 범곡일동"],
            "법정동": ["초량동", "수정동", "좌천동"],
            "매매가_억": [4.2, 3.9, 1.8],
    ...
    if selected_gu in gu_database:
        ...
        min_year = st.sidebar.slider("최소 준공연도 (건축연한)", 1970, 2025, 1990)
